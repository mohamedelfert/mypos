                    ...
                    <div class="col-lg-4 pull-right">
                        <div class="row text-center" style="margin-top:20px">
                            <div class="form-group">
                                <img class="img-responsive" style="width:100%" alt="@lang('site.image')" src="{{ $user->image_path }}">
                            </div>
                        </div>
                    </div>

                    <div class="col-lg-8 pull-left">
                        <form method="POST" action="{{ route('dashboard.users.profile',$user->id)}}" enctype="multipart/form-data">
                        @csrf
                        @method('patch')
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="password_confirmation" id="password_confirmation" class="form-control"
                                   value="{{ old('password_confirmation') }}" placeholder="@lang('site.password_confirmation')">
